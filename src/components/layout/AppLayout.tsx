...
const navItems = [
  ...
  { to: '/sip', label: 'SIP Tracker', icon: LineChart },
  { to: '/savings-division', label: 'Savings Split', icon: PieChart },
  { to: '/emi', label: 'EMIs', icon: Banknote },
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
              <span className="text-xs font-bold text-primary">{user?.email?.[0]?.toUpperCase() || 'U'}</span>
            </div>
